(ns construction.actor
  "ConstructionManagersActor — the ISCO-08 1323 community construction actor as a
  ...
  The unconditional invariant: the ConstructionManagersAdvisor can never
  directly commit a record the ConstructionManagersGovernor refuses —
...
(defn build-graph
  "Build a compiled ConstructionManagersActor graph. `store` implements
